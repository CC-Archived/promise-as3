package com.codecatalyst.promise.util
{
	...
	public function jQuery() : Object {
		...
		var $ : Object  = { 
			each : function( list:Object, iterator:Function):void {
				/**
			 ...
			 */
			Callbacks : function( flags:String=null ):Callbacks {
			 ...
			 */
			Deferred : function( func:Function=null ):Deferred {
